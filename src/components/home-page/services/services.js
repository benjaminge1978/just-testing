...
export default () => (
    <div className="services-section">
        ...
        <div className="services-cards">
            ...
            <div className="services-cards__item">
                <AniLink cover to="/conferences" direction="up" bg="#FFF" aria-label="conferences">
                    <ConferencesImage />
                </AniLink>
                <h3><AniLink cover to="/conferences" direction="up" bg="#FFF" aria-label="conferences">Conferences</AniLink></h3>
                ...
                <AniLink cover to="/conferences" direction="up" bg="#FFF" aria-label="conferences"><Arrow /></AniLink>
            </div>
            <div className="services-cards__item">
                <AniLink cover to="/event-production" direction="up" bg="#FFF" aria-label="event-production">
                    <EventProductionImage />
                </AniLink>
                <h3><AniLink cover to="/event-production" direction="up" bg="#FFF" aria-label="event-production">Event production</AniLink></h3>
                ...
                <AniLink to="/event-production" direction="up" bg="#FFF" aria-label="event-production"><Arrow /></AniLink>
            </div>
            <div className="services-cards__item">
                <AniLink cover to="/event-management" direction="up" bg="#FFF" >
                    <EventManagementImage />
                </AniLink>
                <h3><AniLink cover to="/event-management" direction="up" bg="#FFF" aria-label="event-management" >Event management</AniLink></h3>
                <p>Known for our impeccable attention to detail, we thrive on the creation and management of large scale events.</p>
                <AniLink cover to="/event-management"direction="up" bg="#FFF" aria-label="event-management"><Arrow /></AniLink>
            </div>
            <div className="services-cards__item">
                <AniLink cover to="/venue-sourcing" direction="up" bg="#FFF" aria-label="event-management">
                    <VenueSourcingImage />
                </AniLink>
                <h3><AniLink cover to="/venue-sourcing" aria-label="event-management" direction="up" bg="#FFF">Venue sourcing</AniLink></h3>
                ...
                <AniLink cover to="/venue-sourcing" direction="up" bg="#FFF" aria-label="event-management"><Arrow /></AniLink>
            </div>
        </div>
    </div>
)