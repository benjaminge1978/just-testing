...
export default ({ data }) => {
  ...
  return (
    <Layout className="about-page-layout">
      <SEO
        title="About Seventa Events"
        description="We are a mighty team, specialising in events"
      />
      <PageHeading
      ...
      <ContainerLabelled
        label={<Arrow />}
        className="about-page-promo"
        innerClassName="about-page-promo__inner"
        labelClassName="about-page-promo__label"
      >
        <PromoImage />
      </ContainerLabelled>
      <ContainerLabelled className="about-page-text about-page-text--blue">
        ...
        <LongDashText className="first-dash">
          <p>
            Fast forward to today and here we are, known for our personality,
            experience and creativity, designing events and experiences that we
            know will leave a lasting impression.
          </p>
        </LongDashText>
      </ContainerLabelled>
      ...
      <ContainerLabelled
        className="about-page-text about-page-text--grey"
        innerClassName="light-bg"
      >
        <p className="light-text">Think BIG</p>
        <h2>Creative individuals bringing ideas to life…</h2>
        <LongDashText>
          <p>
            With our Head Office in Bournemouth based out of a 20,000 sq ft
            industrial warehouse space, we pull together our collective ideas,
            skills, experiences and we make things happen. Creative ideas backed
            up with organised minds. We have been on both sides of the fence, we
            run our own events across the UK, and we also create them for
            others. We are able to think like a client, a customer, and a guest.
          </p>
          <p>
            We are extremely proud of the clients we have, our brands that we
            have built, and the events & experiences we produce.{" "}
          </p>
        </LongDashText>
      </ContainerLabelled>
      {members && members.length ? (
        <div className="team-members-section">
          ...
          >
            ...
            <LongDashText>
              <p>
                Whilst we were founded as an Events agency, we have grown over
                the years into a collective group of creative brands and
                businesses operating at all levels across the event &
                hospitality industry.
              </p>
              <p>
                • Seventa Events -{" "}
                <a href="https://seventa.co.uk/">www.seventa.co.uk</a>
              </p>
              <p>
                • Innovative Hire -{" "}
                <a href="https://innovativehire.co.uk/">
                  www.innovativehire.co.uk
                </a>
              </p>
              <p>
                • Alpine Christmas Markets -{" "}
                <a href="https://christmasinbournemouth.co.uk">
                  www.christmasinbournemouth.co.uk
                </a>
              </p>
              <p>
                • The Street Kings -{" "}
                <a href="https://thestreetkings.co.uk">
                  www.thestreetkings.co.uk
                </a>
              </p>
              <p>
                • ChurrosKings -{" "}
                <a href="https://churroskings.com">www.churroskings.com</a>
              </p>
              <p>
                • The Back Yard Project -{" "}
                <a href="https://thebackyardproject.co.uk">
                  www.thebackyardproject.co.uk{" "}
                </a>
              </p>
            </LongDashText>
          </ContainerLabelled>
